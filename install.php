            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-body p-5">
                        <h1 class="h3 mb-4 text-center">Paghilom Café Management System</h1>
...
define('SITE_NAME', 'Paghilom Café');
...
define('SMTP_FROM_NAME', 'Paghilom Café');
...
?>";
                ...
                <div class="text-center mt-4 text-muted">
                    <small>Paghilom Café Management System v1.0</small>
                </div>
            </div>
        </div>
    </div>
